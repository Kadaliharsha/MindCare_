  ...
  return (
    <div className="w-full h-full bg-white ">
      <div className="w-full h-[500px] bg-[#f5f9fc] flex justify-around  items-center m-auto mt-10">
        <div className="w-[50%] ">
          <h1 className="text-[#008055]   font-normal text-[54px] mb-6 tracking-wider">
            About Us
          </h1>
      ...
      <div className="w-full h-[500px] bg-white flex justify-around  items-center m-auto mt-10 ">
        ...
        <div className="w-[50%]">
          <h1 className="text-[#008055] text-5xl mb-6 tracking-wider font-normal ">
      ...
      <div className="w-full h-[500px] bg-[#FFFFF7] flex justify-around  items-center m-auto mt-10">
        <div className="w-[50%] ">
          <h1 className="text-[#008055]   text-5xl mb-6 tracking-wider">
            Our Story
          </h1>
      ...
      <div className="w-full h-[600px] bg-[#f5f9fc] p-5">
        <h1 className="text-[#008055]   text-5xl  tracking-wider mt-10 text-center mb-10">
          Key Features
        </h1>
        ...
        <div className="flex justify-evenly items-center w-full mt-[40px]">
          ...
          >
            ...
            />
            <div className="w-[80%] h-[70px] m-auto">
